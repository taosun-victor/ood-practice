...
namespace std{
	...
	struct hash<Coordinate>{
		size_t operator() (Coordinate coord) const {
			return hash<int>()(coord.getX()) * 101 + hash<string>()(coord.getY());
		}
	};
}
...
int main(){
	...
	Coordinate coord1(1, "abc");	
	Coordinate coord2(2, "def");
	Coordinate coord3(3, "4");
	Coordinate coord4(1, "abc"); // the same as coord1
